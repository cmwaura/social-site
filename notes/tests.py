...
class NoteBookSinglePageView(SetUpTestMixin, TestCase):
	...
	def setUp(self, *args, **kwargs):
		super(NoteBookSinglePageView, self).setUp(*args, **kwargs)
...
class NoteBookUpdateTestView(SetUpTestMixin, TestCase):
	model_klass = NoteBook

	def setUp(self, *args, **kwargs):
		super(NoteBookUpdateTestView, self).setUp(*args, **kwargs)
